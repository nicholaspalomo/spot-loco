...
class ReplayBuffer(object):
    ...
    def add(
        ...
        self.state[self.ptr:(self.ptr+1)*num_envs,:] = state
        self.action[self.ptr:(self.ptr+1)*num_envs,:] = action
        self.next_state[self.ptr:(self.ptr+1)*num_envs,:] = next_state
        self.reward[self.ptr:(self.ptr+1)*num_envs,:] = reward[:, np.newaxis]
        self.not_done[self.ptr:(self.ptr+1)*num_envs,:] = 1. - done[:, np.newaxis]
